...
path = 'C:\\Users\\integral\\Documents\\work\\git_repos\\SEL_modbus\\Resources\\modbus-eaton-address-strings.pkl'
with open(path, 'rb') as handle:
    address_strings = pickle.load(handle)
...
def fetch_eaton_dictionary(address_strings = address_strings, client):
    d = {}
